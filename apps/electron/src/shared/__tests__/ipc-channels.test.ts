...
const EXPECTED_CHANNELS: string[] = [
  ...
  'LLM_Connection:getOpenCodeModels',
  'LLM_Connection:list',
  ...
  'sessions:getPermissionAllowances',
  ...
  'settings:getSensitiveContextProtection',
  'settings:getSensitivePathAllowRules',
  'settings:getServerConfig',
  'settings:getServerStatus',
  'settings:removeSensitivePathAllowRule',
  'settings:setDefaultThinkingLevel',
  'settings:setNetworkProxy',
  'settings:setSensitiveContextProtection',
