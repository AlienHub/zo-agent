...
We take security seriously. If you discover a security vulnerability in Zo, please report it responsibly.
...
- The Zo desktop application
- The `@craft-agent/*` npm packages
- Official Zo repositories
