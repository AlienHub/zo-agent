  ...
  protected async *chatImpl(
    ...
    try {
      ...
      const fullMcpServers: Options['mcpServers'] = {
        ...
        // Zo documentation - always available for searching setup guides
        ...
        systemPrompt: miniConfig.enabled
          ...
          : {
              ...
              append: getSystemPrompt(
                ...
                // Anthropic SDK path is always image-capable (anthropic_compat routes
                // to the Pi backend), so vision-dependent prompt guidance stays on.
                true
              ),
            },
          ...
          yield {
            ...
            error: isCwdCause ? {
              ...
              message:
                ...
                'or a security tool removed it). Reinstalling Zo typically fixes this.',
              details: [
