...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    GET_PERMISSION_ALLOWANCES: 'sessions:getPermissionAllowances',
    EVENT: 'session:event',
  ...
  settings: {
    ...
    GET_SENSITIVE_CONTEXT_PROTECTION: 'settings:getSensitiveContextProtection',
    SET_SENSITIVE_CONTEXT_PROTECTION: 'settings:setSensitiveContextProtection',
    GET_SENSITIVE_PATH_ALLOW_RULES: 'settings:getSensitivePathAllowRules',
    REMOVE_SENSITIVE_PATH_ALLOW_RULE: 'settings:removeSensitivePathAllowRule',
